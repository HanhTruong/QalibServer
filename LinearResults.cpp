...
FILENAME:	LinearResults.cpp

--------------------------------------------------------------------
MODULE DESCRIPTION:
	Linear results calibration report processing.

--------------------------------------------------------------------
GLOBAL FUNCTIONS:
	HRESULT LinearCalibrationResults
...
--------------------------------------------------------------------
INVOCATION: 
	Build->Compile	LinearResults.cpp
...
Get results for sigmoidal algorithm.
...
LOCAL
	...
	lLCID - Language code, used by conversion functions.
			i.e. VarR8FromStr.
								 ...
								 VARIANT *error_msg)
{
	...
	{
		LogErrorMessage(hr, 
				"Return from \"SetDescriptionLabels\"",
				"LinearCalibrationResults");
		return hr;
	}
	...
	{
		LogErrorMessage(hr, 
				"Return from \"GetFitParameters\". Original fit parameters",
				"LinearCalibrationResults");
		return hr;
	}
	...
	{
		LogErrorMessage(hr, 
				"Return from \"GetFitParameters\". New fit parameters",
				"LinearCalibrationResults");
		return hr;
	}
	...
	{
		LogErrorMessage(hr, 
				"Return from \"GetMaxAndMinLimits\"",
				"LinearCalibrationResults");
		return hr;
	}
	...
	{
		LogErrorMessage(hr, 
				"Return from \"GetDisposition\". New fit parameters",
				"LinearCalibrationResults");
		return hr;
	}
	...
	{
		LogErrorMessage(hr, 
				"Return from \"GetDisposition\". Original fit parameters",
				"LinearCalibrationResults");
		return hr;
	}
								 ...
								 VARIANT *error_msg)
{
	...
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Return from \"GetFitParsLimits\" function","GetMaxAndMinLimits");
		return hr;
	}
	...
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Correlation coefficient\" MINIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	...
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Correlation coefficient\" MAXIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	...
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Bartlett's test\" MINIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	...
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Bartlett's test\" MAXIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	...
	hr = SafeArrayPutElement(psaMinLimits, &i, &LowerLimits[0]);
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Slope\" MINIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	//*** Put "Slope" MAXIMUM value in array to return ***
	hr = SafeArrayPutElement(psaMaxLimits, &i, &UpperLimits[0]);
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Slope\" MAXIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	...
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Slope standard error\" MINIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	...
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Slope standard error\" MAXIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	...
	hr = SafeArrayPutElement(psaMinLimits, &i, &LowerLimits[1]);
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Intercept\" MINIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	//*** Put "Intercept" MAXIMUM value in array to return ***
	hr = SafeArrayPutElement(psaMaxLimits, &i, &UpperLimits[1]);
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Intercept\" MAXIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	...
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Intercept standard error\" MINIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
	...
	if (FAILED(hr))
	{
		LogErrorMessage(hr,"Put \"Intercept standard error\" MAXIMUM value in array to return","GetMaxAndMinLimits");
		return hr;
	}
